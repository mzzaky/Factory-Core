    ...
    public String onRequest(OfflinePlayer player, @NotNull String params) {
        ...
        if (params.equals("factories_owned")) {
            ...
            int playerFactoryCount = plugin.getPlayerFactoryManager() != null
                    ...
                    : 0;
            return String.valueOf(factories.size() + playerFactoryCount);
        }
        ...
        if (params.equals("factories_running")) {
            ...
            if (plugin.getPlayerFactoryManager() != null) {
                running += plugin.getPlayerFactoryManager().getFactoriesByOwner(player.getUniqueId())
                        .stream()
                        .filter(pf -> pf.getStatus() == com.aithor.factorycore.models.FactoryStatus.RUNNING)
                        .count();
            }
        ...
        if (params.equals("total_value")) {
            double total = plugin.getFactoryManager().getFactoriesByOwner(player.getUniqueId())
                    ...
                    .sum();
            if (plugin.getPlayerFactoryManager() != null) {
                total += plugin.getPlayerFactoryManager().getFactoriesByOwner(player.getUniqueId())
                        .stream()
                        .mapToDouble(com.aithor.factorycore.models.PlayerFactory::getPrice)
                        .sum();
            }
