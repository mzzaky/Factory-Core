...
public class DistributionEvent {
    ...
    private final List<String> commandOnLeave;
    ...
    public DistributionEvent(String id, String name, List<String> lore, double chance, int time,
        ...
        this.commandOnLeave = commandOnLeave;
    }
    ...
    public List<String> getCommandOnAppear() {
        return commandOnAppear;
    }

    public List<String> getCommandOnComplete() {
        return commandOnComplete;
    }

    public List<String> getCommandOnLeave() {
        return commandOnLeave;
    }
}
